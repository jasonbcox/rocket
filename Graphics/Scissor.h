	...
	namespace Graphics {
		...
		public:
			Scissor( float orthoWidth, float orthoHeight,
				int topLeftX, int topLeftY, int regionWidth, int regionHeight );		// Create an orthographic scissor
			Scissor( float FOVy, float aspectRatio, float nearClip, float farClip,
				int topLeftX, int topLeftY, int regionWidth, int regionHeight );			// Create a perspective scissor
			~Scissor();
